...
if(isset($_POST["search"]["value"]))
{
 ...
 OR question LIKE "%'.$_POST["search"]["value"].'%" 
 OR genre LIKE "%'.$_POST["search"]["value"].'%" 
 OR options LIKE "%'.$_POST["search"]["value"].'%" 
 ';
}
...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="options">' . $row["options"] . '</div>';
